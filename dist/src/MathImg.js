var MathImg = /** @class */ (function () {
    ...
    MathImg.toTricolor = function (img) {
        ...
        //variable donde guardamos la salida
        var sal = this.initArray(img.getWidth(), img.getHeight());
        //Define los puntos de inicio y de final para poder dividir en tres partes
        var inicio = 0, termino = img.getWidth() / 3;
        console.log(inicio, termino);
        // Recorre las filas de la imagen.
        for (var i = 0; i < img.getHeight(); i++) {
            // Recorre la 1ra tercera parte de la imagen.
        ...
        // aqui se actualiza los puntos de inicio y fin para la 2da tercera parte de la imagen
        inicio = termino;
        termino = 2 * img.getWidth() / 3;
        // Recorre las filas de la imagen.
        for (var i = 0; i < img.getHeight(); i++) {
            // Recorre la 2da tercera parte de la imagen.
            for (var j = inicio; j < termino; j++) {
                sal[0][i][j] = arrImage[0][i][j];
        ...
        // Recorre la tercera parte de la imagen.
        for (var i = 0; i < img.getHeight(); i++) {
            for (var j = inicio; j < termino; j++) {
                sal[0][i][j] = arrImage[0][i][j];
                sal[1][i][j] = 0;
    ...
    MathImg.toHorizontalTricolor = function (img) {
        // Variable que guarda el arreglo 3D de la imagen de color
        var arrImage = img.getArrayImg();
        // Variable donde guardamos la salida
        var sal = this.initArray(img.getWidth(), img.getHeight());
        ...
        //parte de inmedio
        // Actualiza los puntos de inicio y final para la segunda tercera parte de la imagen.
        inicio = termino;
        termino = 2 * img.getHeight() / 3;
        // Recorre la 2da tercera paarte de la imagen
        for (var i = inicio; i < termino; i++) {
            for (var j = 0; j < img.getWidth(); j++) {
                sal[0][i][j] = arrImage[0][i][j];
                sal[1][i][j] = arrImage[0][i][j];
        ...
        //parte de abajo
        //// Actualiza los puntos de inicio y final para la  tercera parte de la imagen
        inicio = termino;
        termino = img.getHeight();
        //recorre la ultima parte de la imagen
        for (var i = inicio; i < termino; i++) {
            for (var j = 0; j < img.getWidth(); j++) {
                sal[0][i][j] = arrImage[0][i][j];
                sal[1][i][j] = 0;
